...
export const routes: Routes = [
  ...
  {path: 'class-groups/detail/:id', component: ClassgroupDetailComponent, canActivate: [authGuard]},
  {path: 'class-groups/overview', component: ClassgroupOverviewComponent, canActivate: [authGuard]},
